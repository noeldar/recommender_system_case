...
class SessionDataset:
    ...
    def __init__(self, data, sep='\t', session_key='sessionid', item_key='productid', time_key='time', n_samples=-1,
...
def create_model(args):
    ...
    #inputs = Input(batch_shape=(None, 1, args.train_n_items))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train-path', type=str, default='../train_tr.txt')
    parser.add_argument('--eval-only', type=bool, default=False)
    parser.add_argument('--dev-path', type=str, default='../train_valid.txt')
    parser.add_argument('--test-path', type=str, default='../events_df_reorganized_test.txt')
    ...
    args.train_n_items = len(args.train_data['productid'].unique()) + 1
    ...
    model = tensorflow.keras.models.load_model("GRU4REC_9.h5")
    train_dataset = SessionDataset(args.train_data)
